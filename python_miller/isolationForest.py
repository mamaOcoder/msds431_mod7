...
# Add code to write anomaly labels to file
iforestPythonLabelDF = pd.DataFrame(iforestPreds) 
iforestPythonLabelDF.to_csv("../results/pythonAnomalyLabels.csv", index_label=True, header=["anomalyLabel"])
